        ...
        <main className="max-w-xl mx-auto">
          ...
          <section className="flex items-center justify-center mb-8">
            <a
              ...
              className={` mt-4 text-white bg-gradient-to-r from-red-500 to-blue-500 hover:bg-gradient-to-l outline outline-offset-2 outline-2 outline-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-200 rounded-lg py-2 px-4 font-semibold ${!generatedImage ? 'opacity-50 cursor-not-allowed' : ''}`}
              style={{ pointerEvents: generatedImage ? 'auto' : 'none' }}>
              Download The Image!
            </a>
          </section>
        </main>
